...
if you need an idea of how much this project has cooked me, i had a dream where the engine had a FULLY WORKING SKELETAL SYSTEM
most people would be with their crush but NO WHY DO I HAVE TO RIG THE STAR OF DAVID
...
wakatime is still acting up, so please continue throwing the dice
...
3. COMPUTE SHADERS (VERY IMPORTANT )
4. new asset format
5. game engine sutff (very complex trust)
6. animation system
8. physics system (or i code it myself (im smart(im not)))
9. build engine skeleton as a dll (for microslop)
10. properly use I'm instead of im
11. cocaine
