...
namespace lte {
	...
	public:
		...
		static void copyBufferToImage(const vk::raii::Buffer& buffer, vk::raii::Image& image, uint32_t width, uint32_t height, vk::raii::Device* device, vk::CommandPool* pool, vk::raii::Queue* queue);
