...
namespace lte {
	...
	public:
		...
		static void copyBufferIndexed(vk::raii::Buffer& srcBuffer, vk::raii::Buffer& dstBuffer, vk::DeviceSize size, singleTimeCommandInfo info, vk::DeviceSize srcOffset, vk::DeviceSize dstOffset);
