...
namespace lte {
	...
	class PipelineDelegate
	{
		...
		public:
			static void createPipelineFast(LtPipeline* pipeline, std::string shaderFilepath, std::string vertShadername, std::string fragShadername, vk::raii::Device& device, vk::raii::PhysicalDevice& physicalDevice, vk::SurfaceFormatKHR* surfaceformat, vk::raii::DescriptorSetLayout& layout);
